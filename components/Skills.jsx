  ...
  return (
    <div id="skills" className="w-full lg:h-screen p-2">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        <p className="text-md sm:text-xl tracking-widest uppercase text-gray-500">
          Skills
        </p>
        <h2 className="py-4 text-2xl md:text-3xl lg:text-4xl tracking-tight text-gray-600 font-sans">
          What I Can Do
        </h2>
